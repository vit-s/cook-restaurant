          ...
          <div className={`col-span-7`}>
            <div className={`m-10 lg:ml-32 lg:mt-20 lg:mb-20`}>
              <Fade
                ...
                triggerOnce={true}
              >
                <h3 className={`text-lg font-normal mb-3 ls-5 text-white`}>
                  Newsletter
                </h3>
              </Fade>
              <Fade
                ...
                triggerOnce={true}
              >
                <h3 className={`text-3xl md:text-5xl font-semibold mb-8 text-white`}>
              ...
              <div>
                <div className={`relative text-white focus-within:text-white flex flex-row-reverse shadow-fi rounded-full`}>
                  <input
                    className={`py-6 sm:py-8 text-sm w-full text-black bg-grey-900 rounded-full pl-4 par-87 focus:outline-none focus:text-black`}
                    type="Email address"
                    name={`q`}
